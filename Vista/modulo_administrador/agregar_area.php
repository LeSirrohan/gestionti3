...
<!-- END GLOBAL MANDATORY STYLES -->
 ...
 <body>
	  	...
	  	<div class="col-md-10">
			...
			<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a class="btn btn-sm blue"  href="areas_soportes.php">
						...
						&nbsp;
							<div class="row">
								<div class="form-group">
									<label class="col-md-3"><h4>Area</h4></label>
									<div class="col-md-9">
										<input type="text" id="area" class="form-control" placeholder="Nombre del area...">
									</div>
								</div>
							</div>
									&nbsp;					
    ...
    <script src="../../js/listarAreas.js"></script>
	<script>
		   ...
		   $("#sig1").on("click", function()
   {
		...
		{	
			location.href="areas_add.php?fecha="+fecha;
