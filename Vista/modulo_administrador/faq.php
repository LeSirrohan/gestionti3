...
<!-- END GLOBAL MANDATORY STYLES -->
 ...
 <body>
	  	...
	  	<div class="col-md-10">
			...
			<div class="portlet box blue-hoki">
				<div class="portlet-title">
					...
					<div class="actions">
						<a class="btn btn-sm blue-madison"  onclick="javascript: window.location='agregar_faq.php'">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover" id="faq">
						<thead align="center">
						<tr>								
							<th width="30%">
								Pregunta
    ...
    <script src="../../js/listarFaq.js"></script>
	<script>
