			...
			<div class="portlet box blue">
				...
				<div class="portlet-body">
					<div class="pull-right">
						<a class="btn default blue-stripe"  onclick="javascript: window.location='agregar_tipo_soporte.php'">
							<i class="fa fa-plus"></i>
							<!-- <img src="../imagenes/add.gif" width="16" height="16"> --> Agregar Tipo de Soporte
						</a>
					</div>
