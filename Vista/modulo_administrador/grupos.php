	  	...
	  	<div class="col-md-10">
			...
			<div class="portlet box blue-hoki">
				<div class="portlet-title">
					...
					<div class="actions">
						<a class="btn btn-sm blue-madison"  onclick="javascript: window.location='agregar_grupo.php'">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover" id="grupos">
						<thead align="center">
						<tr>								
							<th width="90%">
								Nombre del grupo
