...
<table width="820" align="center">
	<tr class="Estilo3">
        <td colspan="2" bgcolor="#FFFFFF" align="center"><a href="../../modulo_reportes/pdfphp/php-pgsql2.php">Imprimir PDF</a></td>
        <td colspan="2" bgcolor="#FFFFFF" align="center"><a href="../../modulo_reportes/pdfphp/php-excel2.php">Imprimir Excel</a></td>
