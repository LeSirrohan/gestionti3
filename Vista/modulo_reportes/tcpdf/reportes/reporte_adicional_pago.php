...
//		$this->Cell(0, 20, 'HOJA N/TOTAL DE HOJAS '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
		...
		$membrete="<b>REPÚBLICA DE PANAMÁ<br>
					...
					ADICIONAL, DIFERENCIA Y CANCELACIÓN DE PAGO</b>";
	...
	public function CuerpoTablaHtml($reg,$fecha_inicio,$fecha_fin,$fecha_registro)
	{
		...
		FROM mov_contraloria as A, mod_descuento AS B WHERE A.id_mov_contraloria = B.id_mov_contraloria
		WHERE B.id_mov_tipo=7 AND A.personal_id=".$this->id;
		...
		$this->Ln();		
		$this->Ln();
		if ($fila2[adicional_tipopago]=='A') {
			$adicional='XX';
			$diferencia='';
			$cancelacion='';
		}
		elseif($fila2[adicional_tipopago]=='D')
		{
			$adicional='';
			$diferencia='XX';
			$cancelacion='';
		}
		elseif($fila2[adicional_tipopago]=="C")
		{
			$adicional='';
			$diferencia='';
			$cancelacion='XX';
		...
		$this->Cell(60, $altura,"TIPO DE PAGO", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(20, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(45, $altura,"Quincena y/o Dias a Enviar", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(45, $altura,"Monto a Pagar o Cancelar", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Ln();
		$this->Cell(35, $altura,"Adicional: ", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(25, $altura,$fila2[adicional_tipopago], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(20, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(20, $altura,"Quincenas", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(25, $altura,$fila2[adicional_quincena], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(45, $altura, "", $border="LTR",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);

		$this->Ln();
		$this->Cell(35, $altura,"Diferencia: ", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		...
		$this->Cell(25, $altura,$fila2[adicional_dias], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(45, $altura, $fila2[adicional_monto], $border="LRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Ln();
		$this->Cell(35, $altura,"Cancelación de Pago: ", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(25, $altura,$fila2[sinsueldo], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Ln();
		$this->Ln();
		...
		$this->Cell(165, $altura,$fila2[adicional_observaciones], $border="B",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Ln();
		$this->Ln();
		$this->Ln();
		$align="C";
...
$pdf->Output('reporte_adicional_pago.pdf', 'I');
