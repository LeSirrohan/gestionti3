...
//		$this->Cell(0, 20, 'HOJA N/TOTAL DE HOJAS '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
	...
	public function CuerpoTablaHtml($reg,$fecha_inicio,$fecha_fin,$fecha_registro)
	{
		...
		$sql1 = " 
			SELECT DISTINCT *
			FROM  inclusion
			WHERE quincena = ".$this->quincena." AND mes =".$this->mes." AND ano=".$this->ano;
		...
		$cabecera = array('Decreto/Resuelto', 'Fecha' , 'Posición','Planilla','*T/I','Cédula Actual','Fecha de Cese','Nombres y Apellidos','Observación');
		...
		$w = array(25, 20,20,20,10,30,30,60,60);
