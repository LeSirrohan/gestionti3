...
//		$this->Cell(0, 20, 'HOJA N/TOTAL DE HOJAS '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
	...
	public function CuerpoTablaHtml($reg,$fecha_inicio,$fecha_fin,$fecha_registro)
	{
		...
		$this->Ln();		
		$this->Ln();
		$this->Cell(45, $altura,"", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(10, $altura, "Día", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		...
		$this->Cell(30, $altura,$fila2[dias_pagar], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Ln();
		$this->Cell(45, $altura,"FECHA DE RETORNO", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(10, $altura, $fila2[dia_retorno], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(10, $altura, $fila2[mes_retorno], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(10, $altura, $fila2[ano_retorno], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(20, $altura,"", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura,"Monto a Descontar", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura,$fila2[monto_descontar], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
...
$pdf->Output('reporte_retorno_licencia.pdf', 'I');
