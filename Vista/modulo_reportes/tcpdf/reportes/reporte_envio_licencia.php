...
//		$this->Cell(0, 20, 'HOJA N/TOTAL DE HOJAS '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
	...
	public function CuerpoTablaHtml($reg,$fecha_inicio,$fecha_fin,$fecha_registro)
	{
		...
		$this->Ln();
		$this->Cell(40, $altura,"", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		...
		$this->SetFont('helvetica', '',10);
		$this->Cell(40, $altura,"Número de Planilla", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		...
		$this->Ln();		
		$this->Ln();
		$this->Cell(45, $altura,"TIPO DE LICENCIA", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(20, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(45, $altura,"Meses/Dias a Enviar", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura,"Desde", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura,"Hasta", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Ln();
		$this->Cell(20, $altura,"Con Sueldo", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(25, $altura,$fila2[consueldo], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(20, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(20, $altura,"Meses", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(25, $altura,$fila2[meses], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		...
		$this->Cell(10, $altura, "Año", $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Ln();
		$this->Cell(20, $altura,"Sin Sueldo", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(25, $altura,$fila2[sinsueldo], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(20, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(20, $altura,"Dias", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);		
		$this->Cell(25, $altura,$fila2[dias], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(30, $altura, "", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(10, $altura, $fila2[dia_desde], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(10, $altura, $fila2[mes_desde], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(10, $altura, $fila2[ano_desde], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(10, $altura, $fila2[dia_hasta], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(10, $altura, $fila2[mes_hasta], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(10, $altura, $fila2[ano_hasta], $border="LTRB",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);

		
		$this->Ln();
		$this->Ln();
		$this->Cell(30, $altura,"Tipo de Licencia", $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(1, $altura , "",  $border=0,$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Cell(165, $altura,$fila2[tipo_licencia], $border="B",$ln,$align,$fill,$link,$stretch,$ignore_min_height,$calign,$valign);
		$this->Ln();
		$this->Ln();
...
$pdf->Output('reporte_envio_licencia.pdf', 'I');
