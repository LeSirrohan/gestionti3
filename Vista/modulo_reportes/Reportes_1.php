...
<!-- END GLOBAL MANDATORY STYLES -->
 ...
 <body>
  <div class="container">
  <div class="row">
    <div class="col-md-12"><img src="../../imagenes/banner2.fw.png">  
    </div>
  ...
  <div class="row">     
      <div class="col-md-2">
        <ul class="nav">
          <li><a href="index.php">Solicitar Soporte</a></li>
          <li><a href="listar_solicitudes.php">Reporte de Solicitudes</a></li>
          <li><a  class="active" href="usuarios.php">Usuarios</a></li>
        <li><a href="#">Consultas</a></li>      
        <li><a href="componentes.php">Componentes</a></li>      
        <li><a href="areas_soportes.php">Áreas de Soporte</a></li>      
        <li><a href="grupos.php">Grupos</a></li>      
        <li><a href="tipos_soportes.php">Tipo Soporte</a></li>      
        <li><a href="#">Consultas</a></li>      
          <li><a href="#">Volver a Intranet</a></li>
        </ul>
    </div>      
