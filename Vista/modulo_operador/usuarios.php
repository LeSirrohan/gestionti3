								...
								<form action="#" class="form-horizontal">
									<div class="form-body">
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control input-circle" placeholder="Nombre">									
											</div>
										</div>
										<div id="Areas">
										</div>
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control input-circle" placeholder="Repita Contraseña">									
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<div class="input-group">
													<select type="password" class="form-control input-circle" placeholder="Contraseña">
