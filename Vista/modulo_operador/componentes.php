...
<!-- END GLOBAL MANDATORY STYLES -->
 ...
 <body>
			...
			<div class="portlet box blue">
				...
				<div class="portlet-body">
					<div class="pull-right">
						<a class="btn default blue-stripe"  onclick="javascript: window.location='agregar_componentes.php'">
							<i class="fa fa-plus"></i>
							<!-- <img src="../imagenes/add.gif" width="16" height="16"> --> Agregar Componente
						</a>
					</div>
					<table class="table table-striped table-bordered table-hover" id="soportes">
						<thead align="center">
						<tr>
							<th width="10%">
								Margen
    ...
    <script src="../../js/listarComponentes.js"></script>
	<script>
